        ...
        <div style={{ maxWidth: 320 }}>
          ...
          <div>
            <i>
              ...
              happens when the Flux benchmarking system for that particular node does not enforce requirements
              compliance.
            </i>
          </div>
        </div>
    ...
    <TooltipTableHeader
      ...
      tooltipContent={
        <div style={{ maxWidth: 300 }}>
          <div>
            <strong>Maintenance Window: </strong> It shows the amount of time in minutes, a node operator must perform
            maintenance since the last time the node was confirmed on the network. Every node is confirmed between 240 –
            320 minutes.
          </div>
          <hr />
          <div>
    ...
    <TooltipTableHeader
      ...
      tooltipContent={
        <div style={{ maxWidth: '250px' }}>
          Enterprise score is an aggregated score taking maturity, node tier, identity and collateral into account".
          UPNP nodes are not considered thus have 0.
        </div>
      }
    />
  );
